package zzzPractica.BuscaMinesEnVentana.MinesXRM.Controlador;
import zzzPractica.BuscaMinesEnVentana.MinesXRM.Model.Model;
import zzzPractica.BuscaMinesEnVentana.MinesXRM.Vista.Vista;
...
public class Controlador
{
    ...
    public static int[] tamano()
    {
        ...
        String resposta;
        do {
            resposta = Vista.pedriTamanoPred();
            bandera = false;
            ...
            switch (resposta)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    resposta = Vista.pedirTamano(); // texto pidiendo la informacion
                    files = Integer.parseInt(resposta.split(" ")[0]);
                    if(files > 50) files = 50;
                    columnes = Integer.parseInt(resposta.split(" ")[1]);
                    if(columnes > 26) columnes = 26;
                    bombes = Integer.parseInt(resposta.split(" ")[2]);
                    System.out.println(files + columnes + bombes);
                    break;
                default:
                    bandera = true;
                    break;
